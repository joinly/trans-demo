...
public class ITransferRpcService {
  ...
  public interface Iface {
    ...
    public ResponseResult unFreeze(UnFreezeModel model) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void unFreeze(UnFreezeModel model, org.apache.thrift.async.AsyncMethodCallback<ResponseResult> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_unFreeze(UnFreezeModel model) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void unFreeze(UnFreezeModel model, org.apache.thrift.async.AsyncMethodCallback<ResponseResult> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      unFreeze_call method_call = new unFreeze_call(model, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class unFreeze_call extends org.apache.thrift.async.TAsyncMethodCall<ResponseResult> {
      private UnFreezeModel model;
      public unFreeze_call(UnFreezeModel model, org.apache.thrift.async.AsyncMethodCallback<ResponseResult> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.model = model;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class unFreeze<I extends Iface> extends org.apache.thrift.ProcessFunction<I, unFreeze_args> {
      ...
      public unFreeze_result getResult(I iface, unFreeze_args args) throws org.apache.thrift.TException {
        unFreeze_result result = new unFreeze_result();
        result.success = iface.unFreeze(args.model);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class unFreeze<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, unFreeze_args, ResponseResult> {
      ...
      public void start(I iface, unFreeze_args args, org.apache.thrift.async.AsyncMethodCallback<ResponseResult> resultHandler) throws org.apache.thrift.TException {
        iface.unFreeze(args.model,resultHandler);
      }
    }
  ...
  public static class unFreeze_args implements org.apache.thrift.TBase<unFreeze_args, unFreeze_args._Fields>, java.io.Serializable, Cloneable, Comparable<unFreeze_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable UnFreezeModel model; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.MODEL, new org.apache.thrift.meta_data.FieldMetaData("model", org.apache.thrift.TFieldRequirementType.REQUIRED, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, UnFreezeModel.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public unFreeze_args(unFreeze_args other) {
      if (other.isSetModel()) {
        this.model = new UnFreezeModel(other.model);
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public UnFreezeModel getModel() {
      return this.model;
    }

    public unFreeze_args setModel(@org.apache.thrift.annotation.Nullable UnFreezeModel model) {
      this.model = model;
      return this;
    }
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, unFreeze_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // MODEL
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.model = new UnFreezeModel();
