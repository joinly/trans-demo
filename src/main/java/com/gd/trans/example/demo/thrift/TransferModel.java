...
public class TransferModel implements org.apache.thrift.TBase<TransferModel, TransferModel._Fields>, java.io.Serializable, Cloneable, Comparable<TransferModel> {
  ...
  private static final int __TRANSAMOUNT_ISSET_ID = 0;
  ...
  public TransferModel setTransAmount(long transAmount) {
    this.transAmount = transAmount;
    setTransAmountIsSet(true);
    return this;
  }
  ...
  public void unsetTransAmount() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __TRANSAMOUNT_ISSET_ID);
  }

  /** Returns true if field transAmount is set (has been assigned a value) and false otherwise */
  public boolean isSetTransAmount() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __TRANSAMOUNT_ISSET_ID);
  }

  public void setTransAmountIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __TRANSAMOUNT_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(transAmount);
